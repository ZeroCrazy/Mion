...
<li class="responsive-table centered card card-content" style="background: red;display: block;padding: 0px;border-radius: 0px;border: 1px solid #444;box-shadow: none;margin: 1px;">
  <a style="color: #fff;text-transform: uppercase;" href="index.php?page=gerentes&edit_comercial='. $resultados['id'] .'">(<b>'. $resultados['distribuidor'] .'</b> &#187; '. $resultados['gerente'] .') <b>'. $resultados['nombre'] .' '. $resultados['primer_apellido'] .' '. $resultados['segundo_apellido'] .'</b></span> | '. $resultados['fecha_baja'] .' | '. $resultados['observaciones'] .'</a>
</li>
';
} else {
	// verde
...
<li class="responsive-table centered card card-content" style="background: green;display: block;padding: 0px;border-radius: 0px;border: 1px solid #444;box-shadow: none;margin: 1px;">
  <a style="color: #fff;text-transform: uppercase;" href="index.php?page=gerentes&edit_comercial='. $resultados['id'] .'">(<b>'. $resultados['distribuidor'] .'</b> &#187; '. $resultados['gerente'] .') <b>'. $resultados['nombre'] .' '. $resultados['primer_apellido'] .' '. $resultados['segundo_apellido'] .'</b></span> | '. $resultados['petic'] .' | '. $resultados['observaciones'] .'</a>
</li>
