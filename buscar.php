  ...
  <h4 class="white-text">&#187; Búsqueda de contratos </h4>
    <div class="card" style="box-shadow: none;text-align: center;">
         <div class="card-content grey-text">
			  <!--input name="" style="background: #eaeaea;border-bottom: 0px;text-align: center;" autocomplete="off" type="search"-->
			  <input autocomplete="off" placeholder="Búsqueda de contrato" style="background: #eaeaea;border-bottom: 0px;text-align: center;" id="search" name="codigo_comercial" type="text" class="form-control" required="">
...
<?php $c_sql = mysql_query("SELECT * FROM contratos"); while($c = mysql_fetch_assoc($c_sql)){ 
...
?>
    window.index.add({
      href: '<?php echo $config['site']; ?>/<a target="_blank" href="index.php?page=edit_contract_id&id=<?php echo $c['id']; ?>"><?php echo $c['nombre_titular']; ?> <?php echo $c['apellidos_titular']; ?> <?php echo $c['dni_cif_titular']; ?>',
	  span: 'nepe',
      title: '<?php echo $c['dni_cif_titular']; ?> <?php echo $c['nombre_titular']; ?> <?php echo $c['apellidos_titular']; ?> <?php echo $c['codigo_comercial']; ?> <?php echo $c['cod_verificacion']; ?> <?php echo $c['telefono_pref_1']; ?> <?php echo $c['telefono_pref_2']; ?> <?php echo $c['correo_electron']; ?> <?php echo $c['cig']; ?> <?php echo $c['cups_gas']; ?> <?php echo $c['cups_luz']; ?> <?php echo $c['ccc_1']; ?><?php echo $c['ccc_2']; ?><?php echo $c['ccc_3']; ?><?php echo $c['ccc_4']; ?>',
...
<?php } ?>
    ...
    var renderResults = function(results) {
      ...
      Array.prototype.forEach.call(results, function(result) {
        var resultDiv = $('<span>' + result[0] + '</span><br>');
