...
if (isset($_POST['add_contract'])) {
	...
	we_dia,we_mes,we_ano,lopd,consumo_pyme,intro_dia,intro_mes,intro_ano) VALUES (
	...
	'$we_dia','$we_mes','$we_ano','$lopd','$consumo_pyme','$intro_dia','$intro_mes','$intro_ano')");
...
<div id="resultadoBusqueda" style="text-align: left;
	...
	<?php if($_GET['tipo_contrato']) { ?>
	  ...
	  <?php } ?>
		...
		<?php if($_GET['formula']){ ?>
	  <div class="col s12 m6">
		<a href="<?php echo $site; ?>/index.php?page=<?php echo $_GET['page']; ?>&tipo_contrato=<?php echo strtoupper($_GET['tipo_contrato']); ?>&formula=<?php echo $_GET['formula']; ?>&formula2=<?php echo $_GET['formula2']; ?>&funciona=si" class="waves-effect waves-light btn" style="width: 100%;<?php if($_GET['funciona'] == 'si'){ echo 'background: #9C213C;'; }else{ echo'background: #444;'; } ?>">Con funciona</a>
	  </div>
	  <div class="col s12 m6">
		<a href="<?php echo $site; ?>/index.php?page=<?php echo $_GET['page']; ?>&tipo_contrato=<?php echo strtoupper($_GET['tipo_contrato']); ?>&formula=<?php echo $_GET['formula']; ?>&formula2=<?php echo $_GET['formula2']; ?>&funciona=no" class="waves-effect waves-light btn" style="width: 100%;<?php if($_GET['funciona'] == 'no'){ echo 'background: #9C213C;'; }else{ echo'background: #444;'; } ?>">Sin funciona</a>
	  </div>
	    <?php } ?>
	  ...
	  <?php if($_GET['funciona']){ // Contrato tipo ?>
		<form method="POST">
		<div class="col s12 m12">
          <div class="card">
	...
	$nnuummeerroo = $numero;
					...
					<div class="input-field col s12 m4">
					  <i class="material-icons prefix">date_range</i>
					  <input id="we_dia" name="we_dia" type="text" pattern="[0-9]{2}" class="validate" style="text-transform: uppercase;" maxlength="2" data-length="2" required>
					  <label for="we_dia">DÍA WE</label>
					</div>
					<div class="input-field col s12 m4">
					  <i class="material-icons prefix">date_range</i>
					  <input id="we_mes" name="we_mes" type="text" pattern="[0-9]{2}" class="validate" style="text-transform: uppercase;" maxlength="2" data-length="2" required>
					  <label for="we_mes">MES WE</label>
					</div>
					<div class="input-field col s12 m4">
					<i class="material-icons prefix">date_range</i>
					<select name="we_ano" pattern="[0-9]{4}" class="validate">
				...
				<div class="col s12 m12">
				  <div class="row">
					...
					<div class="input-field col s12 m6">
					  ...
					  <input id="dni" name="dni_cif_representante" pattern="(([X-Z]{1})([-]?)(\d{7})([-]?)([A-Z]{1}))|((\d{8})([-]?)([A-Z]{1}))" maxlength="9" data-length="9" onblur="nif(this.value)" type="text" class="validate" style="text-transform: uppercase;">
					  <label for="dni">DNI / NIE / CIF</label>
					</div>
					<div class="input-field col s12 m6">
    ...
    <li>
      ...
      <div class="collapsible-body"><span>
		...
		<div class="input-field col s12 m4">
					...
					<div class="input-field col s12 m6">
					  <i class="material-icons prefix">location_on</i>
					  <input id="municipio_provincia" name="municipio_ps" type="text" class="validate" style="text-transform: uppercase;" required>
	...
	<li>
	  ...
	  <div class="row">
				...
				<div class="row">
					...
					<input autocomplete="off" onKeyUp="cupsluz();" id="busquedaCL" onblur="valida_cups(this.value)" name="cups_luz" type="text" class="validate" style="text-transform: uppercase;" required>
					<label for="busquedaCL">CUPS Electricidad</label>
					  ...
					  <?php if($_GET['formula2'] == 'gas'){ ?>
						<div class="input-field col s12 m4">
						  ...
						  <input autocomplete="off" onKeyUp="cupsgas();" id="busquedaCG" onblur="valida_cups(this.value)" name="cups_gas" type="text" class="validate" style="text-transform: uppercase;" required>
					...
					<!-- Maximetro -->
					<?php if($_GET['formula'] == 'luz'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="maximetro"><option value="" selected>Escoge una opción</option><option value="Si">Si</option><option value="No">No</option></select><label>MAXÍMETRO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'compromisoluz'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="maximetro"><option value="" selected>Escoge una opción</option><option value="Si">Si</option><option value="No">No</option></select><label>MAXÍMETRO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'maxahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="maximetro"><option value="" selected>Escoge una opción</option><option value="Si">Si</option><option value="No">No</option></select><label>MAXÍMETRO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'dual'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="maximetro"><option value="" selected>Escoge una opción</option><option value="Si">Si</option><option value="No">No</option></select><label>MAXÍMETRO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'planahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="maximetro"><option value="" selected>Escoge una opción</option><option value="Si">Si</option><option value="No">No</option></select><label>MAXÍMETRO</label></div><?php } ?>
					
					<!-- Tipo alta luz -->
					<?php if($_GET['formula'] == 'luz'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_luz"><option value="" selected required>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CC con MT">CC con MT</option><option value="CC con CT y MT">CC con CT y MT</option><option value="CT">CT</option><option value="MT">MT</option><option value="NA">NA</option><option value="CT con MT">CT con MT</option></select><label>TIPO ALTA LUZ</label></div><?php } ?>
					<?php if($_GET['formula'] == 'compromisoluz'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_luz"><option value="" selected required>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CC con MT">CC con MT</option><option value="CC con CT y MT">CC con CT y MT</option><option value="CT">CT</option><option value="MT">MT</option><option value="NA">NA</option><option value="CT con MT">CT con MT</option></select><label>TIPO ALTA LUZ</label></div><?php } ?>
					<?php if($_GET['formula'] == 'maxahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_luz"><option value="" required>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CC con MT" selected>CC con MT</option><option value="CC con CT y MT">CC con CT y MT</option><option value="CT">CT</option><option value="MT">MT</option><option value="NA">NA</option><option value="CT con MT">CT con MT</option></select><label>TIPO ALTA LUZ</label></div><?php } ?>
					...
					<?php if($_GET['formula'] == 'planahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_luz"><option value="" selected required>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CC con MT">CC con MT</option><option value="CC con CT y MT">CC con CT y MT</option><option value="CT">CT</option><option value="MT">MT</option><option value="NA">NA</option><option value="CT con MT">CT con MT</option></select><label>TIPO ALTA LUZ</label></div><?php } ?>
					...
					<!-- Tarifa acceso -->
					<?php if($_GET['formula'] == 'luz'){ ?><div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_luz" required><option value="" selected>Escoge una opción</option><option value="2.0A">2.0A</option><option value="2.0DHA">2.0DHA</option><option value="2.1A">2.1A</option><option value="2.1DHA">2.1DHA</option><option value="3.0A">3.0A</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'compromisoluz'){ ?><div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_luz" required><option value="" selected>Escoge una opción</option><option value="2.0A">2.0A</option><option value="2.0DHA">2.0DHA</option><option value="2.1A">2.1A</option><option value="2.1DHA">2.1DHA</option><option value="3.0A">3.0A</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'maxahorro'){ ?><div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_luz" required><option value="" selected>Escoge una opción</option><option value="2.0DHA">2.0DHA</option><option value="2.1DHA">2.1DHA</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					...
					<?php if($_GET['formula'] == 'planahorro'){ ?><div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_luz" required><option value="" selected>Escoge una opción</option><option value="2.0A">2.0A</option><option value="2.0DHA">2.0DHA</option><option value="2.1A">2.1A</option><option value="2.1DHA">2.1DHA</option><option value="3.0A">3.0A</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					...
					<!-- Tipo alta gas -->
					<?php if($_GET['formula'] == 'gas'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_gas" required><option value="" selected>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CT">CT</option><option value="NA">NA</option></select><label>TIPO ALTA GAS</label></div></div><?php } ?>
					...
					<?php if($_GET['formula'] == 'planahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_gas" required><option value="" selected>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CT">CT</option><option value="NA">NA</option></select><label>TIPO ALTA GAS</label></div></div><?php } ?>
				
					<!-- Tarifa acceso gas -->
					<?php if($_GET['formula'] == 'gas'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_gas" required><option value="" selected>Escoge una opción</option><option value="3.1">3.1</option><option value="3.2">3.2</option><option value="3.3">3.3</option><option value="3.4">3.4</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'dual'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_gas" required><option value="" selected>Escoge una opción</option><option value="3.1">3.1</option><option value="3.2">3.2</option><option value="3.3">3.3</option><option value="3.4">3.4</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
					<?php if($_GET['formula'] == 'planahorro'){ ?><div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_gas" required><option value="" selected>Escoge una opción</option><option value="3.1">3.1</option><option value="3.2">3.2</option><option value="3.3">3.3</option><option value="3.4">3.4</option></select><label>TARIFA DE ACCESO</label></div><?php } ?>
...
<?php if($_GET['formula'] == 'marca'){ ?>
	...
	<div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tipo_alta_luz"><option value="" selected required>Escoge una opción</option><option value="AD">AD</option><option value="CC">CC</option><option value="CC con CT">CC con CT</option><option value="CC con MT">CC con MT</option><option value="CC con CT y MT">CC con CT y MT</option><option value="CT">CT</option><option value="MT">MT</option><option value="NA">NA</option><option value="CT con MT">CT con MT</option></select><label>TIPO ALTA LUZ</label></div>
	<div class="input-field col s12 m4"><i class="material-icons prefix">bookmark</i><input id="f_luz" name="descuento_luz" type="text" class="validate" required><label for="f_luz">DESCUENTO LUZ (%)</label></div>
	<div class="input-field col s12 m4"><i class="material-icons prefix">shopping_basket</i><select name="tarifa_ref_luz" required><option value="" selected>Escoge una opción</option><option value="2.0A">2.0A</option><option value="2.0DHA">2.0DHA</option><option value="2.1A">2.1A</option><option value="2.1DHA">2.1DHA</option><option value="3.0A">3.0A</option></select><label>TARIFA DE ACCESO</label></div>
...
<?php } ?>
					...
					<?php } ?>
					<?php if($_GET['formula'] == 'luz'){ ?>
					<div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="plan_destino_luz">
					...
					</select><label>Producto Compromiso luz</label></div>
					<?php if($_GET['funciona'] == 'si'){ ?>
					<div class="input-field col s12 m6"><i class="material-icons prefix">shopping_basket</i><select name="plan_destino_fun">
					  <option value="COMPROMISO LUZ <?php if($_GET['funciona'] == 'si'){ echo 'CON FUNCIONA'; } ?>" selected>COMPROMISO LUZ <?php if($_GET['funciona'] == 'si'){ echo 'CON FUNCIONA'; } ?></option>
					</select><label>Producto Compromiso luz con funciona</label></div>
					<?php } ?>
					<?php } ?>
					...
					<?php } ?>
					<div class="col s12 m12">
					  <button class="btn waves-effect waves-light" type="submit" name="add_contract" style="background: #444;width: 100%;">Introducir contrato
