...
<html lang="en">
  <head>
	<title><?php echo $config[sitename]; ?>: Crear void</title>
    <meta charset="utf-8">
...
?>
	  ...
	  <div class="mx-auto" style="width: 200px;">
	    <form method="POST">
		  <button type="submit" name="procedercontrato" class="btn btn-danger" style="padding: 60px 35px;border-radius: 50%;border: 2px solid rgba(0, 0, 0, 0.4);">Nuevo void</button>
		</form>
	  </div>
<?php } ?>
