...
if($_GET[gerente] == ''){
	...
	if($_GET[intro_dia] == ''){
		$objWriter->save($carpeta . "\EXPORT_". utf8_decode($_GET[gerente]) ."_FECHA_$_GET[intro_mes]$_GET[intro_ano].xls");
		echo '<meta http-equiv="refresh" content="1; url='. $site .'/excel/CARGA EDP_'. date(Y) .''. date(m) .''. date(d) .'/EXPORT_'. $_GET[gerente] .'_FECHA_'. $_GET[intro_mes] .''. $_GET[intro_ano] .'.xls" />';
	} else {
		$objWriter->save($carpeta . "\EXPORT_". utf8_decode($_GET[gerente]) ."_FECHA_$_GET[intro_dia]$_GET[intro_mes]$_GET[intro_ano].xls");
		echo '<meta http-equiv="refresh" content="1; url='. $site .'/excel/CARGA EDP_'. date(Y) .''. date(m) .''. date(d) .'/EXPORT_'. $_GET[gerente] .'_FECHA_'. $_GET[intro_dia] .''. $_GET[intro_mes] .''. $_GET[intro_ano] .'.xls" />';
	}
}
