(function ($) {
  $(document).ready(function() {
    ...
    window.index.add({
      href: 'http://10.34.1.76/index.php?page=all_contracts',
    ...
    window.index.add({
      href: 'http://10.34.1.76/breadcrumbs.html',
      title: 'Breadcrumbs',
      body: 'There are 3 main button types described in material design. The raised button is a standard button that signify actions and seek to give depth to a mostly flat page. The floating circular action button is meant for very important functions. Flat buttons are usually used within elements that already have depth like cards or modals.'
    });

    window.index.add({
      href: 'http://10.34.1.76/cards.html',
      title: 'Cards',
    ...
    window.index.add({
      href: 'http://10.34.1.76/carousel.html',
      title: 'Carousel',
    ...
    window.index.add({
      href: 'http://10.34.1.76/checkboxes.html',
      title: 'Checkboxes',
    ...
    window.index.add({
      href: 'http://10.34.1.76/chips.html',
      title: 'Chips',
    ...
    window.index.add({
      href: 'http://10.34.1.76/collapsible.html',
      title: 'Collapsible',
    ...
    window.index.add({
      href: 'http://10.34.1.76/collections.html',
      title: 'Collections',
      body: 'Collections allow you to group list objects together.'
    });

    window.index.add({
      href: 'http://10.34.1.76/color.html',
      title: 'Color',
    ...
    window.index.add({
      href: 'http://10.34.1.76/dropdown.html',
      title: 'dropdown',
      body: 'Add a dropdown list to any button.'
    });

    window.index.add({
      href: 'http://10.34.1.76/feature-discovery.html',
    ...
    window.index.add({
      href: 'http://10.34.1.76/fxdooter.html',
      title: 'fxdooter',
    ...
    window.index.add({
      href: 'http://10.34.1.76/helpers.html',
      title: 'Helpers',
      body: 'helper classes'
    });

    window.index.add({
      href: 'http://10.34.1.76/icons.html',
      title: 'icons',
      body: 'We have included 740 Material Design Icons courtesy of Google'
    });

    window.index.add({
      href: 'http://10.34.1.76/media-css.html',
      title: 'Media CSS',
      body: 'Media CSS classes'
    });

    window.index.add({
      href: 'http://10.34.1.76/media.html',
    ...
    window.index.add({
      href: 'http://10.34.1.76/pickers.html',
      title: 'date time picker',
      body: 'Pickers provide a simple way to select a date or time.'
    });

    window.index.add({
      href: 'http://10.34.1.76/preloader.html',
      title: 'preloader',
    ...
    window.index.add({
      href: 'http://10.34.1.76/select.html',
      title: 'Select',
      body: 'Select allows user input through specified options.'
    });

    window.index.add({
      href: 'http://10.34.1.76/shadow.html',
      title: 'shadow',
    ...
    window.index.add({
      href: 'http://10.34.1.76/showcase.html',
      title: 'showcase',
      body: 'Here is our showcase of websites that use materialize.'
    });

    window.index.add({
      href: 'http://10.34.1.76/sidenav.html',
    ...
    window.index.add({
      href: 'http://10.34.1.76/tabs.html',
      title: 'tabs',
    ...
    window.index.add({
      href: 'http://10.34.1.76/text-inputs.html',
    ...
    window.index.add({
      href: 'http://10.34.1.76/toasts.html',
      title: 'Toasts',
    ...
    window.index.add({
      href: 'http://10.34.1.76/tooltips.html',
      title: 'Tooltips',
    ...
    window.index.add({
      href: 'http://10.34.1.76/typography.html',
      title: 'Typography',
      body: 'font, headers, blockquotes, flow text.'
    });

    window.index.add({
      href: 'http://10.34.1.76/waves.html',
      title: 'waves',
    ...
    $('input#search').on('keyup', debounce(function (e) {
      ...
      var results = window.index.search(query).slice(0, 6).map(function (result) {
        var href = result.ref.split('http://10.34.1.76/')[1];
