...
if (isset($consultaBusqueda)) {
	...
	$consulta = mysql_query("SELECT * FROM contratos WHERE dni_cif_titular='$consultaBusqueda' or codigo_comercial='$consultaBusqueda' or nombre_titular='$consultaBusqueda' or apellidos_titular='$consultaBusqueda' or telefono_pref_1='$consultaBusqueda' or correo_electron='$consultaBusqueda' or cod_verificacion='$consultaBusqueda' or cups_luz='$consultaBusqueda' or cups_gas='$consultaBusqueda' or cig='$consultaBusqueda' or estado_contrato='$consultaBusqueda' or user_contrato_intro='$consultaBusqueda'");
